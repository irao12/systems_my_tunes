...
int main() {
  ...
  printf("\nTesting new_song, insert_front, insert_order, and print list:\n ");
  playlist = NULL;
  ...
  add_to_lib(library, "hold me down", "50 cent");
  ...
  temp = find_song(library, "dynamite", "bts");
  if (!temp) printf("song not found\n");
  else {
    printf("song found! ");
    print_list(temp);
    printf("\n");
  }
  temp = find_song(library, "dna", "bts");
  if (!temp) printf("song not found\n");
  else {
    printf("song found! ");
    print_list(temp);
  ...
  find_artist_lib(library, "justin bieber");
  printf("====================================\n");
